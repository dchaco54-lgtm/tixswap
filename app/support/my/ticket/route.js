...
// Detalle de ticket + conversación + adjuntos (usuario autenticado)

import { getSupabaseAdmin, getUserFromBearer } from "@/lib/support/auth";
...
export async function GET(req) {
  try {
    ...
    if (ticket.user_id !== user.id) return json({ error: "FORBIDDEN" }, 403);
