...
export async function POST(req) {
  try {
    ...
    // Campos opcionales (solo si existen columnas)
    ...
    if (sellerName && (await columnExists(supabase, table, "seller_name"))) insertPayload.seller_name = sellerName;

    // Link con PDF (si tienes columnas)
    ...
    // IMPORTANTE: devolver JSON para que tu front muestre el error real
