...
function SellForm() {
  ...
  // ✅ NUEVO: buscador/selector de eventos (1 sola UI)
  ...
  useEffect(() => {
    // Si ya hay evento seleccionado y el query está vacío, muestra el nombre seleccionado
    if (!eventQuery && selectedEvent) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // ✅ Mantiene el comportamiento "required" aunque ahora sea buscador
    if (!state.eventId) {
    ...
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="mx-auto max-w-5xl px-4">
        ...
        >
          ...
          {/* ✅ Evento (BUSCADOR ÚNICO + lista filtrable, MISMO FORMATO) */}
          <div className="space-y-1" ref={eventBoxRef}>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => {
                  ...
                  setIsEventOpen(true);
                  // Si el usuario cambia texto, reseteamos selección hasta que elija uno
                  setState((prev) => ({ ...prev, eventId: '' }));
                }}
                    ...
                    {filteredEvents.length === 0 ? (
                      ...
                      filteredEvents.map((event) => (
                        <button
                          ...
                          className="w-full px-3 py-3 text-left hover:bg-gray-50 transition"
                        >
            ...
            {/* Mantiene required/validación sin cambiar tu estructura visual */}
            <select
              name="eventId"
              value={state.eventId}
            ...
            {/* (Opcional visual) si quieres ver “seleccionado”, lo dejamos minimal sin tocar layout */}
            {selectedEvent && (
